    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactPlayers", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "GuildRecruitUsers",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    NickName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    UserAvatarPix = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GuildRecruitUsers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GuildUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ContactId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IdentityUserContacts", x => new { x.GuildUserId, x.ContactId });
                    table.ForeignKey(
                        name: "FK_IdentityUserContacts_ContactPlayers_ContactId",
                        column: x => x.ContactId,
                        principalTable: "ContactPlayers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IdentityUserContacts_GuildRecruitUsers_GuildUserId",
                        column: x => x.GuildUserId,
                        principalTable: "GuildRecruitUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
